  ...
  return (
    ...
    <div className="bg-white p-8 rounded-sm shadow-sm">
        ...
        <form action={formAction}>
            ...
            <button type="submit" className={clsx("px-10 py-4 text-center font-semibold text-white w-full bg-orange-400 rounded-sm hover:bg-orange-500 cursor-pointer mt-5", { "opacity-50 cursor-progress animate-pulse" : isPending })} disabled={isPending}>
