        ...
        <table className="w-full divide-y divide-gray-200">
            <thead>
                <tr>
                    ...
                    <th className="px-6 py-3 text-sm font-bold text-gray-700 uppercase text-left">Departure</th>
            ...
            <tbody className="divide-y divide-gray-200">
                ...
                <tr className="hover:bg-gray-100" key={reserve.id}>
                    ...
                    <td className="px-6 py-4">{formatDate(reserve.createdAt.toISOString())}</td>
