        ...
        <div className="grid md:grid-cols-12 gap-5">
            <div className="col-span-8 bg-white p-4">
                ...
                <div className="mb-4 grid md:grid-cols-3">
                    <input type="checkbox" name="ameneties" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded" />
                    <label htmlFor="ameneties" className="ms-2 text-sm font-medium text-gray-900 capitalize">Spa</label>
                    <div aria-live="polite" aria-atomic="true">
                        <span className="text-sm text-red-500 mt-2">message</span>
                    </div>
                </div>
