    ...
    <form action={formAction}>
        <div className="grid md:grid-cols-12 gap-5">
            <div className="col-span-8 bg-white p-4">
                ...
                <div className="mb-4">
                    <textarea name="description" rows={8} className="py-2 px-4 rounded-sm border border-gray-400 w-full" placeholder="Room Description"></textarea>
                    <div aria-live="polite" aria-atomic="true">
            ...
            <div className="col-span-4 bg-white p-4">
                ...
                <button type="submit" className={clsx("bg-orange-400 text-white w-full hover:bg-orange-500 py-2.5 px-6 md:px-10 text-lg font-semibold cursor-pointer", {"opacity-50 cursor-progress": isPending,})} disabled={isPending}>{isPending ? "Saving..." : "Save"}</button>
            </div>
        </div>
    </form>
    </>
